...
import com.cloud.dis.core.ClientParams;
...
import com.cloud.dis.http.Protocol;
import com.cloud.dis.util.compress.CompressionType;
...
public class DISConfig extends Properties implements ClientParams {
    ...
    public String getEndpoint() {
        ...
        return String.format(endpointFormat, getRegion(), "mycloud.com");
    }
