...
package com.otccloud.dis.iface.api.protobuf;
...
import com.otccloud.dis.iface.data.response.Record;
...
public class ProtobufUtils
{
     ...
     * */
    public static PutRecordsResult toPutRecordsResult(com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult putRecordsResult)
    {
        ...
        for(com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResultEntry protoEntry : putRecordsResult.getRecordsList()){
     ...
     * */
    public static com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequest toProtobufPutRecordsRequest(PutRecordsRequest putRecordsParam)
    {
        com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequest.Builder builder = com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequest.newBuilder();
        ...
        for(PutRecordsRequestEntry putRecordsRequestEntry : putRecordsParam.getRecords()){
            com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequestEntry.Builder ebuilder = com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequestEntry.newBuilder();
        ...
        com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequest protoRequest = builder.build();
        return protoRequest;
    }
    
    public static PutRecordsRequest toPutRecordsRequest(com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequest putRecordsParam)
    {
        ...
        for(com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequestEntry protoEntry : putRecordsParam.getRecordsList()){
    ...
    public static com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult toProtobufPutRecordsResult(
        PutRecordsResult putRecordsResult)
    {
        com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult.Builder builder = com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult.newBuilder();
        ...
        for(PutRecordsResultEntry resultEntry : putRecordsResult.getRecords()){
            com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResultEntry.Builder entryBuilder = com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResultEntry.newBuilder();
    ...
    public static com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult toProtobufGetRecordsResult(
        GetRecordsResult getRecordsResult)
    {
        com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult.Builder builder = com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult.newBuilder();
        builder.setNextShardIterator(getRecordsResult.getNextPartitionCursor());
        
        for(Record record : getRecordsResult.getRecords()){
            com.otccloud.dis.iface.api.protobuf.Message.Record.Builder rBuilder = com.otccloud.dis.iface.api.protobuf.Message.Record.newBuilder();
    ...
    public static GetRecordsResult toGetRecordsResult(com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult protoResult)
    {
        GetRecordsResult result = new GetRecordsResult();
        result.setNextPartitionCursor(protoResult.getNextShardIterator());
        
        List<Record> records = new ArrayList<Record>();
        for(com.otccloud.dis.iface.api.protobuf.Message.Record protoRecord : protoResult.getRecordsList()){
