...
package com.otccloud.dis.iface.stream.response;
...
import com.otccloud.dis.iface.data.request.StreamType;
import com.otccloud.dis.iface.stream.request.CSVProperties;
import com.otccloud.dis.iface.stream.request.Tag;
...
public class DescribeStreamResult
{
     ...
     * </ul>
     * 
     * @see com.otccloud.dis.iface.data.request.StreamType
