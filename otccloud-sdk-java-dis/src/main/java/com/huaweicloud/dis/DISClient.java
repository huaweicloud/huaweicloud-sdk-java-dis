...
import com.otccloud.dis.core.DefaultRequest;
import com.otccloud.dis.core.Request;
import com.otccloud.dis.core.http.HttpMethodName;
import com.otccloud.dis.core.restresource.*;
import com.otccloud.dis.core.util.StringUtils;
import com.otccloud.dis.http.AbstractDISClient;
import com.otccloud.dis.http.exception.HttpClientErrorException;
...
import com.otccloud.dis.iface.data.request.*;
import com.otccloud.dis.iface.data.response.*;
import com.otccloud.dis.iface.stream.request.*;
import com.otccloud.dis.iface.stream.response.*;
import com.otccloud.dis.iface.transfertask.request.*;
import com.otccloud.dis.iface.transfertask.response.*;
import com.otccloud.dis.util.ExponentialBackOff;
import com.otccloud.dis.util.Utils;
import com.otccloud.dis.util.cache.CacheResenderThread;
import com.otccloud.dis.util.cache.CacheUtils;
...
public class DISClient extends AbstractDISClient implements DIS {
    ...
    protected final PutRecordsResult innerPutRecords(PutRecordsRequest putRecordsParam) {
        ...
        if (BodySerializeType.protobuf.equals(disConfig.getBodySerializeType())) {
            ...
            com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult putRecordsResult = request(protoRequest.toByteArray(), request, com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult.class);
    ...
    protected final GetRecordsResult innerGetRecords(GetRecordsRequest getRecordsParam) {
        ...
        if (BodySerializeType.protobuf.equals(disConfig.getBodySerializeType())) {
            ...
            com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult protoResult = request(getRecordsParam, request, com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult.class);
