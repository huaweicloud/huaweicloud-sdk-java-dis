...
import com.otccloud.dis.iface.transfertask.request.*;
import com.otccloud.dis.iface.transfertask.response.*;
import org.apache.http.HttpRequest;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.otccloud.dis.DISConfig.BodySerializeType;
...
import com.otccloud.dis.core.restresource.AppsResource;
import com.otccloud.dis.core.restresource.CheckPointResource;
import com.otccloud.dis.core.restresource.CursorResource;
import com.otccloud.dis.core.restresource.RecordResource;
import com.otccloud.dis.core.restresource.ResourcePathBuilder;
import com.otccloud.dis.core.restresource.StreamResource;
import com.otccloud.dis.core.restresource.TransferTaskResource;
import com.otccloud.dis.core.util.StringUtils;
import com.otccloud.dis.http.AbstractCallbackAdapter;
import com.otccloud.dis.http.AbstractFutureAdapter;
import com.otccloud.dis.iface.api.protobuf.ProtobufUtils;
import com.otccloud.dis.iface.app.request.CreateAppRequest;
import com.otccloud.dis.iface.app.request.ListAppsRequest;
import com.otccloud.dis.iface.app.request.ListStreamConsumingStateRequest;
import com.otccloud.dis.iface.app.response.DescribeAppResult;
import com.otccloud.dis.iface.app.response.ListAppsResult;
import com.otccloud.dis.iface.app.response.ListStreamConsumingStateResult;
import com.otccloud.dis.iface.data.request.CommitCheckpointRequest;
import com.otccloud.dis.iface.data.request.DeleteCheckpointRequest;
import com.otccloud.dis.iface.data.request.GetCheckpointRequest;
import com.otccloud.dis.iface.data.request.GetPartitionCursorRequest;
import com.otccloud.dis.iface.data.request.GetRecordsRequest;
...
import com.otccloud.dis.iface.data.response.CommitCheckpointResult;
import com.otccloud.dis.iface.data.response.DeleteCheckpointResult;
import com.otccloud.dis.iface.data.response.GetCheckpointResult;
import com.otccloud.dis.iface.data.response.GetPartitionCursorResult;
import com.otccloud.dis.iface.data.response.GetRecordsResult;
...
import com.otccloud.dis.iface.stream.request.CreateStreamRequest;
import com.otccloud.dis.iface.stream.request.DeleteStreamRequest;
import com.otccloud.dis.iface.stream.request.DescribeStreamRequest;
import com.otccloud.dis.iface.stream.request.ListStreamsRequest;
import com.otccloud.dis.iface.stream.request.UpdatePartitionCountRequest;
import com.otccloud.dis.iface.stream.request.UpdateStreamRequest;
import com.otccloud.dis.iface.stream.response.CreateStreamResult;
import com.otccloud.dis.iface.stream.response.DeleteStreamResult;
import com.otccloud.dis.iface.stream.response.DescribeStreamResult;
import com.otccloud.dis.iface.stream.response.ListStreamsResult;
import com.otccloud.dis.iface.stream.response.UpdatePartitionCountResult;
import com.otccloud.dis.iface.stream.response.UpdateStreamResult;
...
public class DISClientAsync2 extends AbstractDISClientAsync implements DISAsync{
        ...
        AsyncHandler<GetRecordsResult> asyncHandler)
    {
        ...
        if(BodySerializeType.protobuf.equals(disConfig.getBodySerializeType())){
            ...
            AsyncHandler<com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult> finalAsyncHandler = null;
            ...
            Future<com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult> getRecordsProtobufFuture = requestAsync(getRecordsParam, request, com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult.class, finalAsyncHandler);
    ...
    private static class GetRecordsFuture extends AbstractFutureAdapter<GetRecordsResult, com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult> implements Future<GetRecordsResult>{
		@Override
		protected GetRecordsResult toT(com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult innerT) {
    ...
    private static class GetRecordsCallback extends AbstractCallbackAdapter<com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult, GetRecordsResult> implements AsyncHandler<com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult>{
		...
		@Override
		protected GetRecordsResult toInnerT(com.otccloud.dis.iface.api.protobuf.Message.GetRecordsResult result) {
			GetRecordsResult getRecordsResult = ProtobufUtils.toGetRecordsResult(result);
			return getRecordsResult;
		}
    }

    private static class PutRecordsFuture extends AbstractFutureAdapter<PutRecordsResult, com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult> implements Future<PutRecordsResult>{

		@Override
		protected PutRecordsResult toT(com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult innerT) {
			return ProtobufUtils.toPutRecordsResult(innerT);
		}
    	
    }
    
    private static class PutRecordsCallback extends AbstractCallbackAdapter<com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult, PutRecordsResult> implements AsyncHandler<com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult>{

		public PutRecordsCallback(AsyncHandler<PutRecordsResult> innerAsyncHandler,
				AbstractFutureAdapter<PutRecordsResult, com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult> futureAdapter) {
			super(innerAsyncHandler, futureAdapter);
		}

		@Override
		protected PutRecordsResult toInnerT(com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult result) {
	...
	private Future<PutRecordsResult> innerPutRecordsAsync(PutRecordsRequest putRecordsParam,
    	...
    	if(BodySerializeType.protobuf.equals(disConfig.getBodySerializeType())){
            ...
            com.otccloud.dis.iface.api.protobuf.Message.PutRecordsRequest protoRequest = ProtobufUtils.toProtobufPutRecordsRequest(putRecordsParam);
            ...
            Future<com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult> putRecordsProtobufFuture = requestAsync(protoRequest.toByteArray(), request, com.otccloud.dis.iface.api.protobuf.Message.PutRecordsResult.class, putRecordsCallback);
