...
import com.otccloud.dis.http.Protocol;
import com.otccloud.dis.util.compress.CompressionType;
...
public class DISConfig extends Properties implements ClientParams {
    ...
    public String getEndpoint() {
        ...
        return String.format(endpointFormat, getRegion(), "myotccloud.com");
    }
